...
- minimal enum/sum type declarations with nullary variants such as `type Room = Hall | Cave`, including checked construction by variant name and equality
