...
fn print_agent_bootstrap() {
    ...
    println!(
        "  duplicate evidence, shallow examples, vacuous or non-executable forall blocks, and shallow properties are low-signal evidence warnings with indexed removal actions where available"
    );
    println!(
