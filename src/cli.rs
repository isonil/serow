...
const CORE_AGENT_COMMANDS: &[AgentCommand] = &[
    ...
    (
        ...
        "Emit deterministic Rust source, write a generated Rust crate, or verify an existing generated crate with optional binary entrypoint, stale optional artifact detection, configurable package name, Cargo/JSON provenance metadata, and generated evidence tests for the supported checked IR subset.",
    ),
    (
        "fmt",
