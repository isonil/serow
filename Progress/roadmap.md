...
- Expand structured patch coverage:
  ...
  - update examples/properties/contracts/intents/implementations through AST-aware edits _(Started: evidence commands append contracts, examples, and properties; `patch set-intent` replaces intents; `patch set-impl` replaces existing implementation expressions.)_
