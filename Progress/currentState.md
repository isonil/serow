...
- Latest closure: Serow is at `1.0.6-rust-bootstrap` after a public v1 patch release that lets `patch set-type` replace enum variants as well as record fields while still rejecting accidental record/enum kind changes.
