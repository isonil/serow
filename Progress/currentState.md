...
- Latest cleanup: the docs/release gate now derives heading anchors from Markdown link labels instead of including inline/reference link destination text in generated slugs.
