...
- Latest closure: Serow is at `1.0.7-rust-bootstrap` after a public v1 patch release that makes `docs` and `version` distinguish unknown option flags from positional extras in structured usage diagnostics.
