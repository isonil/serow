...
- Latest closure: Serow is at `1.0.24-rust-bootstrap` after a public v1 hardening patch that rejects malformed project-manifest string values with trailing non-JSON content.
