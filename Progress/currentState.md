...
- Latest release-polish closure: top-level JSON help now lists `serow help [--json]` in the same full command catalog it returns, and text usage/project metadata advertise the help entrypoint consistently.
