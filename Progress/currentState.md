...
- Latest closure: Serow is at `1.0.5-rust-bootstrap` after a public v1 patch release that makes invalid top-level help arguments honor the structured JSON `UsageError` protocol.
