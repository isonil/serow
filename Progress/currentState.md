...
- Latest cleanup: checker-time boolean evaluation now short-circuits `and`/`or`, matching the Rust backend and avoiding evaluation errors in operands that the boolean result does not need.
