...
- Phase 3 Rust backend:
  ...
  - emits deterministic Rust source on stdout in text mode and includes the generated source, deterministic Serow input fingerprint, deterministic generated source fingerprint, and source-location-aware symbol-to-Rust-name rows in JSON mode
  ...
  - records deterministic `package.metadata.serow` manifest rows for the backend id, IR version, Serow input fingerprint, generated source fingerprint, generated type/function/test counts, source-location-aware type and function symbol-to-Rust-name mappings, binary entrypoint symbol/Rust-name/source-location metadata, and source-location-aware example/property evidence-to-test mappings in generated crates
