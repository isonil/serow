...
- Latest cleanup: docs-check external link detection now treats URI-scheme and protocol-relative Markdown targets as external instead of resolving them as local paths.
