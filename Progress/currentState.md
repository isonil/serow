...
- Latest closure: Serow is at `1.0.19-rust-bootstrap` after a public v1 patch release that makes `bin/serow docs --check` reject missing full/collapsed reference-style Markdown link definitions.
