...
- Latest closure: Serow is at `1.0.23-rust-bootstrap` after a public v1 patch release that adds safe boolean-list access through `get_bool` and the `core.list.list_bool_get` helper.
