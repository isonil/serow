...
- Latest closure: Serow is at `1.0.25-rust-bootstrap` after a public v1 hardening patch that accepts valid commented or spaced Cargo `[package]` table headers when reading release metadata.
