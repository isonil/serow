...
- Latest closure: Serow is at `1.0.26-rust-bootstrap` after adding safe finite-float list access through `get_float`/`MaybeFloat`, matching the existing non-panicking concrete list access intrinsics.
