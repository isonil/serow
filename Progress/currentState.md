...
- Latest closure: Serow is at `1.0.16-rust-bootstrap` after a public v1 patch release that makes `bin/serow docs --check` ignore Markdown link syntax shown inside fenced or inline code examples.
