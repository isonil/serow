...
- Latest release-polish closure: JSON usage diagnostics for invalid `serow check --profile ...` now point agents back to `serow check` instead of suggesting the certification command.
