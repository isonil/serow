...
- Latest cleanup: Rust backend float-producing expressions now guard generated results with the same finite-`Float` invariant enforced by checked Serow evaluation.
